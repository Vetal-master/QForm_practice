...
def create_experiment(path_geometry, VX, VY, VZ=-1):  # цикл
    ...
    # DRIVE-----------------
    arg2 = DbProperty()
    arg2.db_path = r'doc:drive/Vx==1'  # название привода
    arg2.prop_path = r'parts/17/value:32/x'  # если Vx  -  то x и т.д.
    arg2.value = r'-1'  # направление скорости
    qform.db_property_set(arg2)

    # Nominal velocity [mm/s]
    arg5 = DbProperty()
    arg5.db_path = r'doc:drive/Vx==1'
    arg5.prop_path = r'hyd_speed'
    arg5.value = r'1'  # скорость по модулю
    qform.db_property_set(arg5)

    # Maximum load [MN]
    arg6 = DbProperty()
    arg6.db_path = r'doc:drive/Vx==1'  # меняем только путь
    arg6.prop_path = r'hyd_max_load'
    arg6.value = r'1e10'
    qform.db_property_set(arg6)

    # Nominal to maximum load ratio
    arg7 = DbProperty()
    arg7.db_path = r'doc:drive/Vx==1'  # меняем только путь
    arg7.prop_path = r'hyd_loadpercent'
    arg7.value = r'1'
    qform.db_property_set(arg7)

    # Drive type
    arg9 = DbProperty()
    arg9.db_path = r'doc:drive/Vx==1'  # меняем только путь
    arg9.prop_path = r'hyd_type'
    arg9.value = r'ind'
    qform.db_property_set(arg9)

    arg8 = SrcTargetPath()
    arg8.source_path = r'doc:drive/Vx==1'  # название привода
    arg8.target_path = r'doc:drive/Vx==1'  # меняем только путь
    qform.db_object_save(arg8)

    arg17 = Property()
    arg17.object_type = ObjectType.Tool
    arg17.object_id = 3  # меняем только путь
    arg17.path = r'drive_id'
    arg17.property_type = PropertyType.Value
    arg17.value = r'doc:drive/Vx==1'
