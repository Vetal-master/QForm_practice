...
qform.start(global_project_conf.path_client_QForm)

arg1 = FileName()
arg1.file = global_project_conf.path_base_script
...
arg3 = FileObject()
arg3.file = r'C:\Users\Belugin\Desktop\По практике Студентов 2022\Геометрия\sphere.stp'  # геометрия
...
arg17.value = r'doc:drive/Vy=+0.5'  # входной параметр
...
arg18.value = r'doc:drive/Vx=+0.45'  # входной параметр
